...
/* FDCAN2 is the isolated lift/rotator bus.  PB5/PB6 matches the current
 * single-Z-axis bench project.  Its message RAM starts after FDCAN1's
 * 4 standard filters, 8 RX entries and 3 TX entries (48 words). */
void MX_FDCAN2_Init(void)
{
  ...
  hfdcan2.Init.MessageRAMOffset = 48;
